...
if (!$pp['url']) { 
	$url = 'https://github.com/lebarsfa/Packages/releases/download/libopencv-dev.4.9.0.20240807/libopencv-dev.4.9.0_x86_mingw13_staticlib_Release.exe'
	$checksum = 'EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE'
	$url64 = 'https://github.com/lebarsfa/Packages/releases/download/libopencv-dev.4.9.0.20240807/libopencv-dev.4.9.0_x64_mingw13_staticlib_Release.exe'
	...
	$url = 'https://github.com/lebarsfa/Packages/releases/download/libopencv-dev.4.9.0.20240807/libopencv-dev.4.9.0_x86_mingw13_lib_Release.exe'
	$checksum = 'CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC'
	$url64 = 'https://github.com/lebarsfa/Packages/releases/download/libopencv-dev.4.9.0.20240807/libopencv-dev.4.9.0_x64_mingw13_lib_Release.exe'
