...
$url = 'http://firmware.ardupilot.org/Tools/MissionPlanner/MissionPlanner-1.3.80.zip'
$checksum = '8A2BE56905AD38C247721991F76168A936A8B0627D17502016DB8580313FF6A4'
$packageArgs = @{
