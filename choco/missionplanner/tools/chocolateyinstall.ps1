...
$url = 'http://firmware.ardupilot.org/Tools/MissionPlanner/MissionPlanner-1.3.83.zip'
$checksum = 'FF3694F7A9038CAF756545049DD7AEF74E3D0D8FE3586E87AA881045704DD6F9'
$packageArgs = @{
